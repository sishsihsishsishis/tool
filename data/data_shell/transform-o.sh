...
node data_shell/line.js ./data/json/a_results.csv.json 50 > ./data/a_results.json
node data_shell/line.js ./data/json/rppg_results.csv.json 2500 > ./data/rppg_results.json
node data_shell/line.js ./data/json/rppg_sync.csv.json > ./data/rppg_sync.json
node data_shell/line.js ./data/json/v_results.csv.json 50 > ./data/v_results.json
